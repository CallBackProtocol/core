...
import myCustomChain1 from './testnet.json'
...
export class Ethereum {
  ...
  async createPayload(sender, receiver, amount) {
    ...
    const common = new Common({ chain: myCustomChain1})//, eips: [1559] })
    // const common = new Common.custom({ chainId: this.chain_id })
    // CustomChain
    ...
    const transactionData = {
      ...
      gasPrice: this.web3.eth.gas_price, 
      to: receiver,
